...
abstract class $ItemsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String cidade, double longitude, double latitude});
}
...
class _$_ItemsModel implements _ItemsModel {
  ...
  @override
  String toString() {
    return 'ItemsModel(id: $id, cidade: $cidade, longitude: $longitude, latitude: $latitude)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, cidade, longitude, latitude);
...
abstract class _ItemsModel implements ItemsModel {
  const factory _ItemsModel(
      ...
      required final double latitude}) = _$_ItemsModel;
